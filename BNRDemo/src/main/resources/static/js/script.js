...
function connectionSuccess() {
  stompClient.subscribe('/topic/chatbnr', onMessageReceived);
...
function onMessageReceived(payload) {
  ...
  if (message.type === 'newUser') {
    ...
    message.content = message.sender + ' please enter the conversion that you want to make today.';
    message.content +='\n' + 'Please enter the currencies in the following format currency1/currency2 ';
